                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <div id="prev-tandatangan"
                                                    ...
                                                    <p id="prev-nip" style="margin-top: 4px; margin-bottom: 4px">NIP: <?= $setting->nip ? $setting->nip : '-' ?></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
            ...
            for (let a = 0; a < pages; a++) {
                ...
                for (let i = t; i < end; i++) {
                    ...
                    var td = '<div style="display: flex; justify-content: center; align-items: center;">' +
                        ...
                        '<br>' +
                        '<span>' + kepsek + '</span>' +
                        '<p id="prev-nip" style="margin-top: 4px; margin-bottom: 4px">NIP: '+ (nip != "" ? nip : "-") +'</p>' +
                        '</div>' +
                        '</td>' +
                        '</tr>' +
                        '</table>' +
