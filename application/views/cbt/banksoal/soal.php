    ...
    <section class="content mt-1">
        <div class="container-fluid">
            <div class="card card-modern mb-3">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <h6 class="mb-0">
                            <b>Bank Soal:</b> <span class="text-primary"><?= $bank->bank_kode ?></span>
                            <span class="mx-2 text-muted">|</span> 
                            <span class="badge badge-pill badge-light px-3">PG: <?= $bank->tampil_pg ?></span>
                            <span class="badge badge-pill badge-light px-3 ml-1">Essai: <?= $bank->tampil_esai ?></span>
                        </h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-modern">
                <div class="card-header p-2 border-bottom-0 bg-transparent">
                    <ul class="nav nav-pills nav-pills-modern">
                        <li class="nav-item">
                            <a class="nav-link <?= $tab_active == '1' ? 'active' : '' ?>"
                               href="<?= base_url('cbtbanksoal/buatsoal/' . $bank->id_bank . '?tab=1') ?>">
                                Pilihan Ganda
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $tab_active == '2' ? 'active' : '' ?>"
                               href="<?= base_url('cbtbanksoal/buatsoal/' . $bank->id_bank . '?tab=2') ?>">
                                Kompleks
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $tab_active == '3' ? 'active' : '' ?>"
                               href="<?= base_url('cbtbanksoal/buatsoal/' . $bank->id_bank . '?tab=3') ?>">
                                Menjodohkan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $tab_active == '4' ? 'active' : '' ?>"
                               href="<?= base_url('cbtbanksoal/buatsoal/' . $bank->id_bank . '?tab=4') ?>">
                                Isian
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $tab_active == '5' ? 'active' : '' ?>"
                               href="<?= base_url('cbtbanksoal/buatsoal/' . $bank->id_bank . '?tab=5') ?>">
                                Essai
                            </a>
                        </li>
                    </ul>
