            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    ...
                    <p class="mb-0 opacity-75 small uppercase font-weight-bold" style="letter-spacing: 1px">
                        <i class="fas fa-door-open mr-2"></i>Manajemen Ruangan & Lokasi Ujian
                    </p>
                </div>
                <div class="col-sm-6 text-right">
                    ...
                    <button type="button" data-toggle="modal" data-target="#createRuangModal" class="btn btn-sm btn-white px-4 rounded-pill shadow-sm border-0 font-weight-bold" style="color: #1e3c72">
                        <i class="fas fa-plus-circle mr-2"></i> Tambah Ruang
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="card card-modern border-0 shadow-sm mb-4">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
                <div class="card-title font-weight-bold text-dark">
                    <i class="fas fa-building mr-2 text-primary"></i>Daftar Ruang Ujian
                </div>
            </div>
            <div class="card-body p-4">
                <?= form_open('cbtruang/delete', array('id' => 'bulk')); ?>
                <div class="table-responsive">
                    <table id="ruang" class="table-modern-list">
                        <thead>
                        <tr>
...
<div class="modal fade" id="createRuangModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden">
            <div class="modal-header bg-primary text-white py-3 border-0">
                <h6 class="modal-title font-weight-bold" id="createModalLabel">
                    <i class="fas fa-plus-circle mr-2"></i>Tambah Ruang Ujian
                </h6>
            ...
            <div class="modal-body p-4">
                <div class="form-group">
                    <label for="nama_ruang" class="small font-weight-bold text-muted uppercase mb-2">Nama Ruang <span class="text-danger">*</span></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light border-right-0"><i class="fas fa-tag text-muted"></i></span>
                        </div>
                        <input type="text" class="form-control border-left-0" name="nama_ruang" placeholder="Contoh: Lab Komputer 1" required style="background: #f8fafc">
                    </div>
                </div>
                <div class="form-group mb-0">
                    <label for="kode_ruang" class="small font-weight-bold text-muted uppercase mb-2">Kode Ruang <span class="text-danger">*</span></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light border-right-0"><i class="fas fa-code text-muted"></i></span>
                        </div>
                        <input type="text" class="form-control border-left-0" name="kode_ruang" placeholder="Contoh: LAB-01" required style="background: #f8fafc">
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="editRuangModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden">
            <div class="modal-header bg-warning text-white py-3 border-0">
                <h6 class="modal-title font-weight-bold text-white" id="editModalLabel">
                    <i class="fas fa-edit mr-2"></i>Edit Ruang Ujian
                </h6>
                <button type="button" class="close text-white opacity-1" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body p-4">
                <div class="form-group">
                    <label class="small font-weight-bold text-muted uppercase mb-2">Nama Ruang <span class="text-danger">*</span></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light border-right-0"><i class="fas fa-tag text-muted"></i></span>
                        </div>
                ...
                <div class="form-group mb-0">
                    <label class="small font-weight-bold text-muted uppercase mb-2">Kode Ruang <span class="text-danger">*</span></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light border-right-0"><i class="fas fa-code text-muted"></i></span>
                        </div>
