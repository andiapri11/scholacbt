(function ($) {
  $.fn.contentZoomSlider = function (options) {
    ...
    function registerEvents() {
      let $container = $(settings.toolContainer);
      $container.off("click", ".zoom-out").on("click", ".zoom-out", zoomOut);
      $container.off("click", ".zoom-in").on("click", ".zoom-in", zoomIn);
      $container.off("input change", r).on("input change", r, zoomScroll);
    }
