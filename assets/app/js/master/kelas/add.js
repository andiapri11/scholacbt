$(document).ready(function () {
    ...
    $('#jumlah_siswa').multiSelect({
        selectableHeader: "<div class='ms-header'>Daftar Seluruh Siswa</div><input type='text' class='search-input form-control mb-1' autocomplete='off' placeholder='Filter Nama/NIS...'>",
        selectionHeader: "<div id='totalsiswa' class='ms-header'>Siswa di Kelas Ini (0)</div><input type='text' class='search-input form-control mb-1' autocomplete='off' placeholder='Filter Nama/NIS...'>",
        //selectableHeader: "",
        //selectionHeader: "",
        afterInit: function (container) {
            ...
            $('#totalsiswa').text("Siswa di Kelas Ini (" + countList() + ")");
            $('#dualSelectPlaceholder').remove();
            kalkulasiSiswa();
        },
