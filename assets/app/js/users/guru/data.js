		...
		columnDefs: [
			{
				...
				render: function (data, type, row, meta) {
					return `<div class="text-center">
								<button type="button" class="btn btn-reset btn-soft-info btn-round shadow-sm ${data.reset == 0 ? 'bg-light text-muted' : ''}"
			...
			},
			{
				...
				render: function (data, type, row, meta) {
					let btn;
					if (data.aktif > 0) {
						btn = `<button type="button" class="btn btn-nonaktif btn-soft-danger btn-round shadow-sm" data-id="${data.id}" data-nama="${data.nama_guru}" data-toggle="tooltip" title="Nonaktifkan">
								<i class="fas fa-user-slash text-xs"></i>
							</button>`;
					} else {
						btn = `<button type="button" class="btn btn-aktif btn-soft-success btn-round shadow-sm" data-id="${data.id_guru}" data-toggle="tooltip" title="Aktifkan">
